...
export class HomeController {
    ...
    public arrMovie = [
        ...
        },
        {
            ...
            "Poster": "../../../../assets/game thrones.jpg",
            "Metascore": "N/A",
            "imdbRating": "9.5",
            "imdbVotes": "1,046,830",
            "imdbID": "tt0944947",
    ...
    private totalArr = new Subject<number>()
    lengthCheck(data: any){
        this.totalArr.next(data.length);
    }
    listTotal():Observable<any> {
